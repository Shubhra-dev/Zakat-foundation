  ...
  return (
    <>
      <div className="text-center">
        <h2 className="w-5/6 sm:w-3/5 m-auto text-secondary font-semibold text-h3 sm:text-title font-pally py-[4%] leading-tight">
          Want to ask us a question about calculating your Zakat?
        </h2>
      </div>
      <div className="flex items-center gap-4 w-5/6 sm:w-3/5 m-auto pb-6">
