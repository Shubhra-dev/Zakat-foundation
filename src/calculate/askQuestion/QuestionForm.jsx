...
function QuestionForm() {
  return (
    <div className="text-center bg-slate-100 py-[3%]">
      <h2 className="text-secondary font-semibold text-h3 sm:text-title py-[3%] font-pally leading-tight">
      ...
      <div className="w-5/6 m-auto">
        <div className="sm:flex w-full justify-between pb-[3%]">
          <input
            ...
            className="w-full sm:w-[45%] py-3 px-2 text-secondary/60 text-xl border border-b-gray-400 rounded-sm"
          />
          <input
            type="text"
            placeholder="Sur/Last Name"
            className="w-full sm:w-[45%] mt-[3%] sm:mt-0  py-3 px-2 text-secondary/60 text-xl border border-b-gray-400 rounded-sm"
          />
        </div>
