  ...
  return (
    <ApplyLayout tab={1}>
      ...
      <div className="text-center py-[3%] bg-primary px-[3%]">
        <h4 className="text-secondary text-s3 sm:text-paragraph laptop:text-s2 font-normal uppercase text-center pb-2 sm:pb-4">
          Apply for zakat
        </h4>
        <h2 className="w-11/12 laptop:w-4/5 m-auto text-secondary font-semibold text-h3 sm:text-s1 laptop:text-title font-pally pb-2 sm:pb-4">
          You can get help in these three areas
        </h2>
        <p className="w-11/12 laptop:w-4/5 m-auto font-normal text-s3 sm:text-paragraph text-secondary/80 pb-[3%]">
