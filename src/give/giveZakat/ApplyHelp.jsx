...
function ApplyHelp() {
  return (
    ...
    >
      ...
      ></div>
      <div className="w-11/12 laptop:w-7/12 m-auto text-center">
        <h2 className="text-primary font-bold text-[28px] sm:text-s1 laptop:text-title font-pally">
          Helping you donate Zakat to your local community
        </h2>
        <p className="text-primary text-s3 sm:text-s2 laptop:text-s1 font-light py-4">
