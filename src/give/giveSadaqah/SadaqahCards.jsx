...
function SadaqahCards() {
  return (
    <div className="py-[3%] px-[4%]">
      <h2 className="text-h3 sm:text-title text-secondary font-bold font-pally text-center pb-4">
        600% return on your charitable investment
      </h2>
      <p className="text-s3 sm:text-s2 text-secondary/60 font-light text-center pb-2 sm:pb-[2%]">
      ...
      <EqualHeightFlexContainer addedClass="w-full flex-col sm:flex-row relative justify-between gap-8 items-start">
        <div className="bg-gradient-to-b from-primary to-zinc-100 p-4 sm:p-[3%] w-full sm:w-1/2 rounded-xl -z-20 relative overflow-hidden">
          ...
          <h3 className="text-h4 sm:text-h2 text-secondary font-pally font-bold py-[2%]">
            Multiply Your Rewards
          </h3>
          <p className="text-s3 sm:text-s2 text-secondary/80 font-light">
