...
function DonateSadaqah() {
  return (
    <GradientBallBG bg={"accentRed"}>
      <h2 className="text-primary font-bold text-h3 sm:text-s1 laptop:text-title font-pally text-center w-5/6 m-auto tab:w-full tab:m-0">
        Donate to the AL-ZAKATI Growth Fund Today!
      </h2>
      <p className="text-primary text-s3 sm:text-paragraph laptop:text-s2 font-light py-4 w-11/12 laptop:w-8/12 m-auto text-center">
      ...
      <p className="text-primary text-s3 sm:text-paragraph laptop:text-s2 font-light py-4 w-11/2 laptop:w-8/12 m-auto text-center">
